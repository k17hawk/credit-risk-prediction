...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            # print(model)
            # print("done")
            # # Check the shape of the target arrays and feature dataframes
            # print(f"Train features shape: {train_dataframe.shape}")
            # print(f"Train target shape: {train_target_arr.shape}")
            # print(f"Test features shape: {test_dataframe.shape}")
