...
class MovieModel:
    ...
    def predict(self, X):
        ...
        print("the shape of transformed features is:----------------------------------")
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            model_finder = ModelFinder(model_config_path=model_config_file_path)
            print("model finder class is loaded.. ")
            ...
            best_model = model_finder.get_best_model(X=x_train,y=y_train,base_accuracy=base_accuracy)
            print("the best model",best_model)
            
            logging.info(f"Best model found on training dataset: {best_model}")
            
            logging.info(f"Extracting trained model list.")
            random_searched_best_model_list:List[RandomSearchBestModel]=model_finder.random_searched_best_model_list
